 ...
 */
public class PreconditionContainsVariableVisitor implements RQTableVisitor<Boolean>  {

	private Set<Variable> variables;

	public PreconditionContainsVariableVisitor(Set<Variable> variables) {
	...
	public Boolean visit(Requirement requirement) {
		return requirement.getPrecondition().accept(this);
	}
