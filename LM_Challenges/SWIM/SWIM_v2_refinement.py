...
A2=Or(And(sqrtOfWeight[0]>0.0,storeCat[0]==0.0),And(sqrtOfWeight[0]>0.0,storeCat[0]==1.0),And(sqrtOfWeight[0]>0.0,lowSpeedWarningAllowed[0]==2.0,vehAirPress[0]<warningTrigForMinPress[0]))
...
G2=And(Implies(And(sqrtOfWeight[0]>0.0,storeCat[0]==0.0),CalAirspeedMin[0]==1.25921*sqrtOfWeight[0]+10.0),Implies(And(sqrtOfWeight[0]>0.0,storeCat[0]==1.0),CalAirspeedMin[0]==1.33694*sqrtOfWeight[0]+10.0),Implies(And(sqrtOfWeight[0]>0.0,lowSpeedWarningAllowed[0]==2.0,vehAirPress[0]<warningTrigForMinPress[0]),lowSpeedWarningTrue))
