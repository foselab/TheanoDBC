...
sqrtOfWeight=Array('sqrtOfWeight',I,R)
storeCat=Array('storeCat',I,I)
vehAirPress=Array('vehAirPress',I,R)
CalAirspeedMin=Array('CalAirspeedMin',I,R)
lowSpeedWarningAllowed=Array('lowSpeedWarningAllowed',I,R)
swimGet_agcasLowSpeedWarn=Array('swimGet_agcasLowSpeedWarn',I,R)
warningTrigForMinPress=Array('warningTrigForMinPress',I,R)
lowSpeedWarningTrue=Bool('lowSpeedWarningTrue')
...
# Contracts
A1=Or(And(sqrtOfWeight[0]>0.0,storeCat[0]==0.0),And(sqrtOfWeight[0]>0.0,storeCat[0]==1.0),And(sqrtOfWeight[0]>0.0,lowSpeedWarningAllowed[0]==1.0,vehAirPress[0]<warningTrigForMinPress[0]))
A2=Or(And(sqrtOfWeight[0]>0.0,storeCat[0]==0.0),And(sqrtOfWeight[0]>0.0,storeCat[0]==1.0),And(sqrtOfWeight[0]>0.0,lowSpeedWarningAllowed[0]==1.0,vehAirPress[0]<=warningTrigForMinPress[0]))
G1=And(Implies(And(sqrtOfWeight[0]>0.0,storeCat[0]==0.0),CalAirspeedMin[0]==1.25921*sqrtOfWeight[0]+10.0),Implies(And(sqrtOfWeight[0]>0.0,storeCat[0]==1.0),CalAirspeedMin[0]==1.33694*sqrtOfWeight[0]+10.0),Implies(And(sqrtOfWeight[0]>0.0,lowSpeedWarningAllowed[0]==1.0,vehAirPress[0]<warningTrigForMinPress[0]),lowSpeedWarningTrue))
G2=And(Implies(And(sqrtOfWeight[0]>0.0,storeCat[0]==0.0),CalAirspeedMin[0]==1.25921*sqrtOfWeight[0]+10.0),Implies(And(sqrtOfWeight[0]>0.0,storeCat[0]==1.0),CalAirspeedMin[0]==1.33694*sqrtOfWeight[0]+10.0),Implies(And(sqrtOfWeight[0]>0.0,lowSpeedWarningAllowed[0]==1.0,vehAirPress[0]<=warningTrigForMinPress[0]),lowSpeedWarningTrue))
