...
count_roll_output_exceeding_50=Array('count_roll_output_exceeding_50',I,I)
count_pitch_output_exceeding_50=Array('count_pitch_output_exceeding_50',I,I)
count_yaw_output_exceeding_50=Array('count_yaw_output_exceeding_50',I,I)
count_airspeed_output_exceeding_32=Array('count_airspeed_output_exceeding_32',I,I)
count_height_output_exceeding_32=Array('count_height_output_exceeding_32',I,I)
roll_command_acceleration=Array('roll_command_acceleration',I,R)
pitch_command_acceleration=Array('pitch_command_acceleration',I,R)
yaw_command_acceleration=Array('yaw_command_acceleration',I,R)
airspeed_command_acceleration=Array('airspeed_command_acceleration',I,R)
height_command_acceleration=Array('height_command_acceleration',I,R)
...
A1=True
A2=True
G1=And(count_roll_output_exceeding_50[0]<=100.0,count_pitch_output_exceeding_50[0]<=100.0,count_yaw_output_exceeding_50[0]<=100.0,count_airspeed_output_exceeding_32[0]<=100.0,count_height_output_exceeding_32[0]<=100.0,roll_command_acceleration[0]<=50.0,pitch_command_acceleration[0]<=50.0,yaw_command_acceleration[0]<=50.0,airspeed_command_acceleration[0]<=32.0,height_command_acceleration[0]<=32.0)
G2=And(count_roll_output_exceeding_50[0]<=100.0,count_pitch_output_exceeding_50[0]<=100.0,count_yaw_output_exceeding_50[0]<=100.0,count_airspeed_output_exceeding_32[0]<=100.0,count_height_output_exceeding_32[0]<=100.0,roll_command_acceleration[0]<=50.0,pitch_command_acceleration[0]<=50.0,yaw_command_acceleration[0]<=50.0,airspeed_command_acceleration[0]<=33.0,height_command_acceleration[0]<=31.0)
