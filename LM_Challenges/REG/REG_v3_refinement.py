...
G2=And(count_roll_output_exceeding_50[0]<=100.0,count_pitch_output_exceeding_50[0]<=100.0,count_yaw_output_exceeding_50[0]<=100.0,count_airspeed_output_exceeding_32[0]<=100.0,count_height_output_exceeding_32[0]<=100.0,roll_command_acceleration[0]<=50.0,pitch_command_acceleration[0]<=50.0,yaw_command_acceleration[0]<=50.0,airspeed_command_acceleration[0]<=32.0,height_command_acceleration[0]<=31.0)
