...
To run _Theano_, copy the file [Theano.jar](https://github.com/foselab/Theano/releases) in this folder. Then run:
...
- t: type (consistency | completeness | composition | refinement)
...
(a) Open [MATLAB Simulink](https://www.mathworks.com/help/install/ug/install-products-with-internet-connection.html), generate the .rt files running the following command:
...
Make sure you meet the other [requirements](#install), then:
...
4. In Requirements2Z3 folder, run the setup file from terminal
